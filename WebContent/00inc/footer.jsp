                ...
                <div class="col-lg-12 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="../10main/index.html"><img src="../bs/img/logo.png" alt=""></a>
                        </div>
                        <ul>
                ...
                <div class="col-lg-12">
                    <div class="footer__copyright">
                        ...
                        <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
 								...
 								All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by Colorlib
						</p>
						</div>
                        <div class="footer__copyright__payment"><img src="../bs/img/payment-item.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
